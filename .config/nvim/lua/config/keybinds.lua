...
keymap("n", "<leader>ff", "<cmd>FzfLua git_files<CR>")     -- Find files in git repo
keymap("n", "<leader>fb", "<cmd>FzfLua buffers<CR>")       -- List open buffers
keymap("n", "<leader>fg", "<cmd>FzfLua grep_project<CR>")  -- Grep across project
keymap("n", "<leader>fl", "<cmd>FzfLua grep_last<CR>")     -- Repeat last grep
keymap("n", "<leader>fh", "<cmd>FzfLua help_tags<CR>")     -- Search help tags
keymap("n", "<leader>fs", "<cmd>FzfLua git_stash<CR>")     -- Browse git stash
keymap("n", "<leader>fd", "<cmd>FzfLua diagnostics_document<CR>") -- Document diagnostics
